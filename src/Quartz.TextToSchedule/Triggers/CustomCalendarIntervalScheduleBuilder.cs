...
namespace Quartz.TextToSchedule.Triggers
{
    /// <summary>
    ...
    public class CustomCalendarIntervalScheduleBuilder : ScheduleBuilder<ICalendarIntervalTrigger>
    {
        ...
        protected CustomCalendarIntervalScheduleBuilder()
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static CustomCalendarIntervalScheduleBuilder Create()
        {
            return new CustomCalendarIntervalScheduleBuilder();
        }
        ...
        {
            CustomCalendarIntervalTriggerImpl st = new CustomCalendarIntervalTriggerImpl();
        ...
        public CustomCalendarIntervalScheduleBuilder WithInterval(int interval, IntervalUnit unit)
        {
        ...
        /// <seealso cref="ICalendarIntervalTrigger.RepeatInterval" />
        /// <seealso cref="ICalendarIntervalTrigger.RepeatIntervalUnit" />
        public CustomCalendarIntervalScheduleBuilder WithIntervalInSeconds(int intervalInSeconds)
        {
        ...
        /// <seealso cref="ICalendarIntervalTrigger.RepeatInterval" />
        /// <seealso cref="ICalendarIntervalTrigger.RepeatIntervalUnit" />
        public CustomCalendarIntervalScheduleBuilder WithIntervalInMinutes(int intervalInMinutes)
        {
        ...
        /// <seealso cref="ICalendarIntervalTrigger.RepeatInterval" />
        /// <seealso cref="ICalendarIntervalTrigger.RepeatIntervalUnit" />
        public CustomCalendarIntervalScheduleBuilder WithIntervalInHours(int intervalInHours)
        {
        ...
        /// <seealso cref="ICalendarIntervalTrigger.RepeatInterval" />
        /// <seealso cref="ICalendarIntervalTrigger.RepeatIntervalUnit" />
        public CustomCalendarIntervalScheduleBuilder WithIntervalInDays(int intervalInDays)
        {
        ...
        /// <seealso cref="ICalendarIntervalTrigger.RepeatInterval" />
        /// <seealso cref="ICalendarIntervalTrigger.RepeatIntervalUnit" />
        public CustomCalendarIntervalScheduleBuilder WithIntervalInWeeks(int intervalInWeeks)
        {
        ...
        /// <seealso cref="ICalendarIntervalTrigger.RepeatInterval" />
        /// <seealso cref="ICalendarIntervalTrigger.RepeatIntervalUnit" />
        public CustomCalendarIntervalScheduleBuilder WithIntervalInMonths(int intervalInMonths)
        {
        ...
        /// <seealso cref="ICalendarIntervalTrigger.RepeatInterval" />
        /// <seealso cref="ICalendarIntervalTrigger.RepeatIntervalUnit" />
        public CustomCalendarIntervalScheduleBuilder WithIntervalInYears(int intervalInYears)
        {
        ...
        public CustomCalendarIntervalScheduleBuilder WithMisfireHandlingInstructionIgnoreMisfires()
        {
        ...
        public CustomCalendarIntervalScheduleBuilder WithMisfireHandlingInstructionDoNothing()
        {
        ...
        public CustomCalendarIntervalScheduleBuilder WithMisfireHandlingInstructionFireAndProceed()
        {
        ...
        public CustomCalendarIntervalScheduleBuilder InTimeZone(TimeZoneInfo timezone)
        {
        ...
        public CustomCalendarIntervalScheduleBuilder PreserveHourOfDayAcrossDaylightSavings(bool preserveHourOfDay)
        {
        ...
        public CustomCalendarIntervalScheduleBuilder SkipDayIfHourDoesNotExist(bool skipDay)
        {
        ...
        internal CustomCalendarIntervalScheduleBuilder WithMisfireHandlingInstruction(int readMisfireInstructionFromString)
        {
