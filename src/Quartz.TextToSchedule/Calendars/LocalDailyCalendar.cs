...
namespace Quartz.TextToSchedule.Calendars
{
    /// <summary>
    ...
    public class LocalDailyCalendar : BaseCalendar
    {
        ...
        /// <summary>
        /// Create a <see cref="LocalDailyCalendar" /> with a time range defined by the
        ...
        /// </ul>
        /// </summary>
        public LocalDailyCalendar(string rangeStartingTime, string rangeEndingTime)
        {
        ...
        public LocalDailyCalendar(ICalendar baseCalendar, string rangeStartingTime, string rangeEndingTime)
            : base(baseCalendar)
        {
            SetTimeRange(rangeStartingTime, rangeEndingTime);
        }
        ...
        public LocalDailyCalendar(int rangeStartingHourOfDay,
        ...
        /// <param name="rangeEndingSecond">The range ending second.</param>
        /// <param name="rangeEndingMillis">The range ending millis.</param>
        public LocalDailyCalendar(ICalendar baseCalendar,
        ...
        public LocalDailyCalendar(DateTime rangeStartingCalendarUtc, DateTime rangeEndingCalendarUtc)
        {
        ...
        public LocalDailyCalendar(long rangeStartingTimeInMillis, long rangeEndingTimeInMillis)
        {
        ...
        protected LocalDailyCalendar(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            int version;
            try
        ...
        /// <summary>
        /// Sets the time range for the <see cref="LocalDailyCalendar" /> to the times
        ...
        {
            if ((obj == null) || !(obj is LocalDailyCalendar))
                return false;
            else
                return Equals((LocalDailyCalendar)obj);
